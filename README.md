...
- Show a warning if the given version is not the latest compared to the latest version available on [PyPI](https://pypi.org) package index. The warning includes the package name, the given version, and the latest version.
